...
(function (weatherGraph, undefined) {
  ...
  weatherGraph.getObservationGraph = function (fmisid, type, timestamp) {
    if (fmisid !== undefined) {
      ...
      $('#graph-box-loader').html(
        '<span align=center>' +
          translations[window.selectedLanguage]['loadObservations'] +
          "... <img src='symbols/default.gif' style='width:20px;'></img></span>"
      );
  ...
  weatherGraph.constructWeatherGraph = function (container, fmisid) {
    ...
    html +=
      '<div id="weather-chart-' + fmisid + '_windrose" style="width:100%; height:400px;"></div>';
    ...
    html +=
      '<div id="weather-chart-' + fmisid + '_radiation" style="width:100%; height:400px;"></div>';
    html +=
      '<div id="weather-chart-' + fmisid + '_air_radio" style="width:100%; height:400px;"></div>';
    html +=
      '<div id="weather-chart-' +
      fmisid +
      '_magnetometer" style="width:100%; height:400px;"></div>';
    html += '<div id="weather-chart-' + fmisid + '_snow" style="width:100%; height:400px;"></div>';
    html += '</div>';
