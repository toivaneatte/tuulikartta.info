...
(function (Tuulikartta, undefined) {
    ...
    html += '<br/>'
    html += '<input id="road-observations" type="checkbox"> '+translations[window.selectedLanguage]['roadObs']
    html += '<br/>'
    html += '<br/>'
  ...
  Tuulikartta.populateInfoWindow = function (data,fmisid) {
    ...
    var stationType = '<b>'+translations[window.selectedLanguage]['stationType']+':</b> <span id="station-type">'+data['type']+'</span> <br>'
