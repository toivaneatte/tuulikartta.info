...
describe("main.js utilities", () => {
  ...
  describe("resolveGraphStartposition", () => {
    it("should return 1 for wind speed parameters", () => {
      expect(globalThis.window.resolveGraphStartposition("ws_10min")).to.equal(
        1,
      );
      expect(globalThis.window.resolveGraphStartposition("wg_10min")).to.equal(
        1,
      );
    });
    ...
    it("should return 2 for temperature parameters", () => {
      ...
      expect(globalThis.window.resolveGraphStartposition("dewpoint")).to.equal(
        2,
      );
    });

    it("should return 2 for precipitation parameters", () => {
      expect(globalThis.window.resolveGraphStartposition("ri_10min")).to.equal(
        2,
      );
    ...
    it("should return 1 as default for unknown parameters", () => {
      expect(
        globalThis.window.resolveGraphStartposition("unknown_param"),
      ).to.equal(1);
      expect(globalThis.window.resolveGraphStartposition("")).to.equal(1);
      expect(globalThis.window.resolveGraphStartposition("invalid")).to.equal(
        1,
      );
    });
    ...
    it("should handle null and undefined gracefully", () => {
      ...
      expect(globalThis.window.resolveGraphStartposition(undefined)).to.equal(
        1,
      );
    });
  });
